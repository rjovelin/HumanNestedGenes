...
ax1 = CreateAx(3, 1, 1, fig, NumMeans, NumSEM, [0, 0.2, 0.4], [0.1, 0.3, 0.5], ['Ext', 'Int', 'Not'], ['#feb24c','#fd8d3c','lightgrey'], 'Introns / gene', 20)
ax2 = CreateAx(3, 1, 2, fig, LengthMeans, LengthSEM, [0, 0.2, 0.4], [0.1, 0.3, 0.5], ['Ext', 'Int', 'Not'], ['#feb24c','#fd8d3c','lightgrey'], 'Intron length (Kbp)', 20)
ax3 = CreateAx(3, 1, 3, fig, HostIntronMeans, HostIntronSEM, [0, 0.2], [0.1, 0.3], ['With\nInt', 'No\nInt'], ['#d95f0e','#fee391'], 'Intron length (Kbp)', 70)
