# -*- coding: utf-8 -*-
"""
Created on Mon Jun 26 18:37:05 2017
...
# under a model in which genes are able to extend and contract length up to 50% of their actual size 
...
newfile = open('SimulationsGeneLength.json', 'w')  
